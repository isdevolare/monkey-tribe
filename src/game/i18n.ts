...
const dict: Record<string, Entry> = {
  ...
  "watchTower.unlock.archer": { tr: "Okçu saldırı bonusu", en: "Archer attack bonus" },
  "watchTower.unlock.power": { tr: "Önerilen düşman gücünü göster", en: "Show enemy recommended power" },
