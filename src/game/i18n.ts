...
const dict: Record<string, Entry> = {
  ...
  "royalPalace.level.1": { tr: "Saray Bahçesi", en: "Palace Garden" },
  "royalPalace.level.2": { tr: "Keşif Konağı", en: "Scout Lodge" },
  "royalPalace.level.3": { tr: "Muhafız Avlusu", en: "Guard Courtyard" },
